...
/* 
  --- Styles ---
*/
const logoDivClass = 'md:w-fit flex justify-center items-center animate-fade-in';

const logoImageClass = 'px-4 absolute top-50% md:left-6 left-0 transition-all-eio-500';
