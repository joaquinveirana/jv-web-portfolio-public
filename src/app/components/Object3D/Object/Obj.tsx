...
export const Obj = (props: Obj3DProps) => {
  ...
  useFrame(() => {
    ...
    rotationClockwise ? (scene.rotation.y += props.rotationSpeed) : (scene.rotation.y -= props.rotationSpeed);
  });
  return <primitive object={scene} scale={props.scale} position={props.position} rotation={props.rotation} />;
};
