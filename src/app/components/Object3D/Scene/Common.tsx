...
import { AmbientLightProps, CommonProps, PointLightProps } from '@/app/props/CommonProps';

export const Common = (props: CommonProps) => (
  <Suspense fallback={null}>
    {props.backgroundColor && <color attach="background" args={[props.backgroundColor]} />}
    ...
    {props.light.point.map((light: PointLightProps, index: number) => {
      return <pointLight key={index} intensity={light.intensity} color={light.color} position={light.position} />;
    })}
