...
/* 
  --- Styles ---
*/
const titleContainerClass = 'md:my-0 md:pt-4 md:w-[300px] md:relative md:z-20 pb-2 flex-col-start w-full';
const supraTitleTextClass = 'pr-2 text-cyan-600 font-semibold secondary-sub-paragraph-class';
  ...
  return (
    ...
    >
      ...
      <div className={`flex-row-end ${!props.odd && 'flex-row-reverse'}`}>
        <h1 className={`${titleTextClass} ${!props.odd && 'md:pl-2 pr-0'}`}>{props.name}</h1>
      </div>
    </div>
  );
};
